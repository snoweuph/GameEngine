...
public class Entity {
    ...
    public ArrayList<Class<? extends Component>> putComponent(Component component){
        ...
        //Create a list of Existing Components on the Entity
        ArrayList<Class<? extends Component>> componentsOnEntity = new ArrayList<>();
        ...
        for (Component requiredComponent: component.getRequiredComponents()){
            ...
            componentsOnEntity.addAll(putComponent(requiredComponent));
